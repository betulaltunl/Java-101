...
public class GelismisHesapMakinesi {
    ...
    static void mod(){
        Scanner scan = new Scanner(System.in);
        System.out.print("Modu alinacak(bolunen) degeri giriniz :"); 
        int integer1=scan.nextInt();
        System.out.print("Bolen degeri giriniz :"); 
        int integer2=scan.nextInt();
        int result= integer1%integer2;
        System.out.println("Sonuç : " + result);
    }
    static void sekilHesabi(){
        Scanner scan = new Scanner(System.in);
        System.out.print("Uzun kenari giriniz :"); 
        int integer1=scan.nextInt();
        System.out.print("Kisa kenari giriniz :"); 
        int integer2=scan.nextInt();
        int alanResult=integer1*integer2;
        int cevreResult=2*(integer1+integer2);
